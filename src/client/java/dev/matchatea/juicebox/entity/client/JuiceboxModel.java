...
public class JuiceboxModel<T extends JuiceboxEntity> extends EntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData box = modelPartData.addChild("box", ModelPartBuilder.create().uv(0, 0).cuboid(-11.0F, -32.0F,
                11.0F, 22.0F, 28.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

        ModelPartData top_r1 = box.addChild("top_r1", ModelPartBuilder.create().uv(-22, 0).cuboid(-3.0F, -32.0F, -3.0F,
                12.0F, 0.0F, 22.0F, new Dilation(0.0F)), ModelTransform.of(-8.0F, 0.0F, 8.0F, 0.0F, 1.5708F, 0.0F));

        ModelPartData right_r1 = box.addChild("right_r1",
                ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -32.0F, -1.0F, 12.0F, 28.0F, 0.0F, new Dilation(0.0F)),
                ModelTransform.of(-10.0F, 0.0F, 8.0F, 0.0F, 1.5708F, 0.0F));

        ModelPartData left_r1 = box.addChild("left_r1", ModelPartBuilder.create().uv(40, 0).cuboid(-3.0F, -32.0F, -1.0F,
                12.0F, 28.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(12.0F, 0.0F, 8.0F, 0.0F, 1.5708F, 0.0F));

        ModelPartData front = box.addChild("front",
                ModelPartBuilder.create().uv(0, 0).cuboid(8.0F, -32.0F, -1.0F, 3.0F, 28.0F, 0.0F, new Dilation(0.0F))
                        ...
                        .uv(58, 0).cuboid(-11.0F, -32.0F, -1.0F, 3.0F, 28.0F, 0.0F, new Dilation(0.0F)),
        ...
        ModelPartData bottom_r1 = straw.addChild("bottom_r1",
                ModelPartBuilder.create().uv(20, 17).cuboid(-4.0F, -32.0F, 15.0F, 5.0F, 0.0F, 5.0F, new Dilation(0.0F))
                        .uv(17, 23).cuboid(-9.0F, -32.0F, 10.0F, 10.0F, 0.0F, 5.0F, new Dilation(0.0F)),
        ...
        ModelPartData shade_r1 = bb_main
                .addChild(
                        "shade_r1", ModelPartBuilder.create().uv(-18, 28).cuboid(-3.0F, -32.0F, -1.0F, 8.0F, 0.0F,
                                18.0F, new Dilation(0.0F)),
                        ModelTransform.of(-8.0F, -1.0F, 15.0F, 1.5708F, 1.0472F, 1.5708F));

        ModelPartData table_r1 = bb_main.addChild("table_r1", ModelPartBuilder.create().uv(-2, 28).cuboid(-4.0F, -32.0F,
                -1.0F, 5.0F, 0.0F, 18.0F, new Dilation(0.0F)),
